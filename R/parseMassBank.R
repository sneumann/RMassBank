#' @param Files A path to the plaintext-records that should be read
#' @return The \code{mbWorkspace} that the plaintext-records.
#' @seealso \code{\link{validate}}
#' @author Erik Mueller
#' @examples \dontrun{
#' 		parseMassBank(c("filepath_to_records/RC00001.txt","filepath_to_records/RC00002.txt))
#' }
#' @export

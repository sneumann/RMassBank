...
the "\Rvar{pos}" at the end was used to denote the polarity; it is
...
\Rfunction{findPeaks} function of XCMS using the
...
obtained pseudospectra are stored in the array \Rvar{specs}.
...
contains, as findPeaks is called by \Rfunction{do.call}.  For example,
...
>>>>>>> 9c3d30b251405e7f267621f5309e2f5843085227
